...
class AddTournaments extends AbstractMigration
{
    public function change()
    {
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_BIG, 'precision' => 11, 'identity' => 'enable'])
            ...
            ->addColumn('team_a_score', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'team_b'])
            ->addColumn('team_b_score', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'team_a_score'])
