...
class AddTournaments extends AbstractMigration
{
    public function change()
    {
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'identity' => 'enable'])
            ...
            ->addColumn('founded_at', 'datetime', ['null' => true, 'after' => 'slug'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_SMALL, 'precision' => 11, 'identity' => 'enable'])
            ...
            ->addColumn('code', 'string', ['null' => false, 'limit' => 8, 'collation' => 'utf8mb4_unicode_ci', 'encoding' => 'utf8mb4', 'after' => 'name'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'identity' => 'enable'])
            ->addColumn('versions_id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'id'])
            ->addColumn('stages_id', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'versions_id'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'identity' => 'enable'])
            ...
            ->addColumn('end_date', 'date', ['null' => true, 'after' => 'start_date'])
            ->addColumn('start_time', 'time', ['null' => false, 'after' => 'end_date'])
            ->addColumn('end_time', 'time', ['null' => true, 'after' => 'start_time'])
            ->addColumn('types_id', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'end_time'])
            ->addColumn('prize_pool', 'decimal', ['null' => true, 'precision' => 14,'scale'=>2, 'after' => 'types_id'])
            ->addColumn('currencies_id', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_SMALL, 'precision' => 3, 'after' => 'prize_pool'])
            ->addColumn('total_teams', 'integer', ['null' => true, 'default' => '0', 'limit' => MysqlAdapter::INT_SMALL, 'precision' => 3, 'after' => 'currencies_id'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_BIG, 'precision' => 11, 'identity' => 'enable'])
            ...
            ->addColumn('groups_id', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'stages_id'])
            ...
            ->addColumn('team_a_score', 'integer', ['null' => false, 'default' => '0','limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'team_b'])
            ->addColumn('team_b_score', 'integer', ['null' => false, 'default' => '0','limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'team_a_score'])
            ->addColumn('game_date', 'date', ['null' => true, 'after' => 'team_b_score'])
            ...
            ->addColumn('match_series_id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 11, 'after' => 'winning_team'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_MEDIUM, 'precision' => 11, 'identity' => 'enable'])
            ...
            ->addColumn('logo', 'string', ['null' => true, 'limit' => 128, 'collation' => 'utf8mb4_unicode_ci', 'encoding' => 'utf8mb4', 'after' => 'url'])
